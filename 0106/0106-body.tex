...
%Otra cosa por lo que me pareció interesante, y tal vez esto es más romántico que otra cosa, es ver cómo de pila y la forma en la que esta es manipulada luego de cada instrucción rememora conceptos de máquinas de Turing 
